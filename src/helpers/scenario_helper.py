...
from src.metadata import format_line
from src.helpers.file_helper import find_files_recursively, filter_out_files_larger_than, is_not_comment, get_col_value, is_not_header
    ...
    for file_path in source_files:
        ...
        with open(file_path, "r") as source_file:
            for line in source_file:
                if is_not_comment(line) and is_not_header(line, header_line):
